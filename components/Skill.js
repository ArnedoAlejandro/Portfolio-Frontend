            ...
            <div className="elemento-visible ">
              ...
              <div className="p-6 max-md:p-3 max-md:mt-4 opacity-80">
                ...
                <p className="max-md:text-start">
                  Design and development of the UI for an online shop selling
                  contactology articles. The development was done using
                  React.js, Next.js, and TailwindCSS, resulting in a dynamic,
                  high-performance interface with custom styles and a responsive
